...
MODEL                = BattHevMm
MODULES              = BattHevMm_msf.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/BattHevMm_msf.mexw64
MAKEFILE             = BattHevMm.mk
...
MODELLIB                  = BattHevMm_msf.mexw64
MODELREF_LINK_LIBS        = C:/Users/Administrator/MATLAB/Projects/examples/HEVMM5/HEVMM/Work/slprj/sim/BattHevMm/BattHevMmlib.lib
MODELREF_LINK_RSPFILE     = BattHevMm_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/BattHevMm \
...
BattHevMm_msf.obj : $(START_DIR)/slprj/sim/BattHevMm/BattHevMm_msf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/sim/BattHevMm/BattHevMm_msf.c
