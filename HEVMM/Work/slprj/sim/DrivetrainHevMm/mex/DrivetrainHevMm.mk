...
MODEL                = DrivetrainHevMm
MODULES              = DrivetrainHevMm_msf.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/DrivetrainHevMm_msf.mexw64
MAKEFILE             = DrivetrainHevMm.mk
...
MODELLIB                  = DrivetrainHevMm_msf.mexw64
MODELREF_LINK_LIBS        = C:/Users/Administrator/MATLAB/Projects/examples/HEVMM5/HEVMM/Work/slprj/sim/DrivetrainHevMm/DrivetrainHevMmlib.lib
MODELREF_LINK_RSPFILE     = DrivetrainHevMm_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/DrivetrainHevMm \
...
DrivetrainHevMm_msf.obj : $(START_DIR)/slprj/sim/DrivetrainHevMm/DrivetrainHevMm_msf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/sim/DrivetrainHevMm/DrivetrainHevMm_msf.c
