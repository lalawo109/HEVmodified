...
#define S_FUNCTION_NAME DrivetrainHevMm_msf
#endif
...
extern const nmdm53plbh oqwsavetja ; const char *
...
static void mdlProcessParameters ( SimStruct * S ) { fykwo0psgw * localX = (
fykwo0psgw * ) ssGetContStates ( S ) ; }
#endif
static void mdlInitializeConditions ( SimStruct * S ) { cqmdrlu31uw * dw = (
cqmdrlu31uw * ) ssGetDWork ( S , 0 ) ; fykwo0psgw * localX = ( fykwo0psgw * )
ssGetContStates ( S ) ; k24opusysu ( & ( dw -> rtm ) , & ( dw -> rtb ) , & (
dw -> rtdw ) , localX ) ; ssSetPeriodicContState ( S , 0 , 6 , -
3.1415926535897931 , 3.1415926535897931 ) ; } static void mdlReset (
SimStruct * S ) { cqmdrlu31uw * dw = ( cqmdrlu31uw * ) ssGetDWork ( S , 0 ) ;
fykwo0psgw * localX = ( fykwo0psgw * ) ssGetContStates ( S ) ; plk0qsxt43 ( &
( dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX ) ; } static void
mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { cqmdrlu31uw * dw = (
cqmdrlu31uw * ) ssGetDWork ( S , 0 ) ; boolean_T const * i_hezmlusthv = (
boolean_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_jhtox3jv1u =
( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_cv5q3v55n3 = (
real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T const * i_c4uii5mopg = (
real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const * i_oek2mwrd2m = (
real_T * ) ssGetInputPortSignal ( S , 4 ) ; real_T const * i_lw0ugh4h02 = (
real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T const * i_pkmw5f5qfi = (
real_T * ) ssGetInputPortSignal ( S , 6 ) ; real_T * o_B_17_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_17_2 = ( real_T * )
ssGetOutputPortSignal ( S , 1 ) ; boolean_T * o_B_17_3 = ( boolean_T * )
ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_17_4 = ( real_T * )
ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_17_5 = ( real_T * )
ssGetOutputPortSignal ( S , 4 ) ; fykwo0psgw * localX = ( fykwo0psgw * )
ssGetContStates ( S ) ; if ( tid == 0 ) { DrivetrainHevMm ( & ( dw -> rtm ) ,
i_hezmlusthv , i_jhtox3jv1u , i_cv5q3v55n3 , i_c4uii5mopg , i_oek2mwrd2m ,
i_lw0ugh4h02 , i_pkmw5f5qfi , o_B_17_1 , o_B_17_2 , o_B_17_3 , o_B_17_4 ,
o_B_17_5 , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX , & ( dw -> rtzce ) )
; ap1xuke5gm ( & ( dw -> rtm ) , & ( dw -> rtdw ) ) ; } } static void
...
mr_DrivetrainHevMm_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S ,
...
false ) ; ssRegisterMsgForNotSupportingMultiExecInst ( S ,
 "<diag_root><diag id=\"Simulink:blocks:LoggingBlockDoesNotSupportMultiExecInstancesWithCustomMsg\" pr=\"d\"><arguments><arg type=\"encoded\"></arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments><hs><h>AAAAX6DJ40DL</h></hs><causes><diag id=\"Simulink:logLoadBlocks:SigLogMultiExecInsNoBusSupportMsg\" pr=\"d\"><msg encoded=\"yes\">TwBuAGwAeQAgAG4AbwBuAC0AYgB1AHMAIABzAGkAZwBuAGEAbABzACAAYwBhAG4AIABiAGUAIABsAG8AZwBnAGUAZAAgAGkAbgBzAGkAZABlACAARgBvAHIAIABFAGEAYwBoACAAcwB1AGIAcwB5AHMAdABlAG0AcwAuAAAA</msg></diag></causes></diag></diag_root>"
...
mr_DrivetrainHevMm_MdlInfoRegFcn ( S , "DrivetrainHevMm" , & retVal ) ; if (
! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( cqmdrlu31uw ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { cqmdrlu31uw * dw = (
cqmdrlu31uw * ) ssGetDWork ( S , 0 ) ; fykwo0psgw * localX = ( fykwo0psgw * )
ssGetContStates ( S ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ;
ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , &
sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } jlbi3xpni1 ( S ,
...
NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } bxqcuynedk ( & (
dw -> rtm ) , & ( dw -> rtdw ) ) ; }
#define MDL_START
static void mdlStart ( SimStruct * S ) { cqmdrlu31uw * dw = ( cqmdrlu31uw * )
ssGetDWork ( S , 0 ) ; c3gpt54oxa ( & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; }
static void mdlOutputs ( SimStruct * S , int_T tid ) { cqmdrlu31uw * dw = (
cqmdrlu31uw * ) ssGetDWork ( S , 0 ) ; boolean_T const * i_hezmlusthv = (
boolean_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_jhtox3jv1u =
( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_cv5q3v55n3 = (
real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T const * i_c4uii5mopg = (
...
DrivetrainHevMmTID2 ( & ( dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) )
; } if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { if (
ssIsSampleHit ( S , 0 , tid ) || ssIsMinorTimeStep ( S ) ) { DrivetrainHevMm
( & ( dw -> rtm ) , i_hezmlusthv , i_jhtox3jv1u , i_cv5q3v55n3 , i_c4uii5mopg
, i_oek2mwrd2m , i_lw0ugh4h02 , i_pkmw5f5qfi , o_B_17_1 , o_B_17_2 , o_B_17_3
, o_B_17_4 , o_B_17_5 , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX , & ( dw
-> rtzce ) ) ; } } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { cqmdrlu31uw * dw = (
cqmdrlu31uw * ) ssGetDWork ( S , 0 ) ; if ( ssIsSampleHit ( S , 0 , tid ) ) {
ap1xuke5gm ( & ( dw -> rtm ) , & ( dw -> rtdw ) ) ; } return ; }
#define MDL_DERIVATIVES
static void mdlDerivatives ( SimStruct * S ) { cqmdrlu31uw * dw = (
cqmdrlu31uw * ) ssGetDWork ( S , 0 ) ; fykwo0psgw * localX = ( fykwo0psgw * )
ssGetContStates ( S ) ; gjkyjt23o3 * localXdot = ( gjkyjt23o3 * ) ssGetdX ( S
) ; hmlhdjth5c ( & ( dw -> rtb ) , & ( dw -> rtdw ) , localX , localXdot ) ;
} static void mdlTerminate ( SimStruct * S ) { cqmdrlu31uw * dw = (
cqmdrlu31uw * ) ssGetDWork ( S , 0 ) ; l4kwgsfseo ( & ( dw -> rtm ) ) ;
return ; }
#define MDL_CLEANUP_RUNTIME_RESOURCES
static void mdlCleanupRuntimeResources ( SimStruct * S ) { cqmdrlu31uw * dw =
( cqmdrlu31uw * ) ssGetDWork ( S , 0 ) ; m44buahda1 ( & ( dw -> rtm ) , & (
dw -> rtdw ) ) ; }
...
mxCreateStructMatrix ( 1 , 1 , 6 , simStateFieldNames ) ; { const fykwo0psgw
* localX = ( const fykwo0psgw * ) ssGetContStates ( S ) ; const size_t
numBytes = sizeof ( fykwo0psgw ) ; mxArray * storedX = mxCreateNumericMatrix
...
mr_DrivetrainHevMm_GetDWork ( ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber (
ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_DrivetrainHevMm_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss
, 0 , 2 , data ) ; } ; mxSetFieldByNumber ( ss , 0 , 3 , mxCreateDoubleScalar
( ( double ) ssGetTNext ( S ) ) ) ; mxSetFieldByNumber ( ss , 0 , 4 ,
mxCreateDoubleScalar ( ( double ) ssGetTNextTid ( S ) ) ) ; { cqmdrlu31uw *
dw = ( cqmdrlu31uw * ) ssGetDWork ( S , 0 ) ; kfhpy22huf * rtm = & ( dw ->
...
fykwo0psgw * localX = ( fykwo0psgw * ) ssGetContStates ( S ) ; const size_t
numBytes = sizeof ( fykwo0psgw ) ; const mxArray * storedX =
mxGetFieldByNumber ( ss , 0 , 0 ) ; const UINT8_T * rawData = ( const UINT8_T
* ) mxGetData ( storedX ) ; memcpy ( localX , & rawData [ 0 ] , numBytes ) ;
} mr_DrivetrainHevMm_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber (
...
mxGetFieldByNumber ( ss , 0 , 5 ) ; cqmdrlu31uw * dw = ( cqmdrlu31uw * )
ssGetDWork ( S , 0 ) ; kfhpy22huf * rtm = & ( dw -> rtm ) ; for ( int i = 0 ;
