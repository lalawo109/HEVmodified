...
MODEL                = HevMmPowertrainController
MODULES              = HevMmPowertrainController_msf.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/HevMmPowertrainController_msf.mexw64
MAKEFILE             = HevMmPowertrainController.mk
MATLAB_ROOT          = D:/Program Files/MATLAB/R2021b
ALT_MATLAB_ROOT      = D:/Program Files/MATLAB/R2021b
START_DIR            = C:/Users/Administrator/MATLAB/Projects/examples/HEVMM5/HEVMM/Work
S_FUNCTIONS_LIB      = $(START_DIR)\slprj\sim\_sharedutils\rtwshared.lib
NUMST                = 1
NCSTATES             = 0
BUILDARGS            = MATLAB_ROOT=%MATLAB_ROOT% ALT_MATLAB_ROOT=%ALT_MATLAB_ROOT% MATLAB_BIN=%MATLAB_BIN% ALT_MATLAB_BIN=%ALT_MATLAB_BIN%  GENERATE_ASAP2=0 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 OPTS="-DIS_SIM_TARGET -DMATLAB_MEX_FILE -DTID01EQ=0"
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 0
ALLOCATIONFCN        = 0
...
COMPILE_FLAGS_OTHER     = 
SYSTEM_LIBS             = -L"D:\Program Files\MATLAB\R2021b\extern\lib\win64\microsoft" libfixedpoint.lib libmwmathutil.lib libmwipp.lib libmwsl_AsyncioQueue.lib sf_runtime.lib libmwslexec_simlog.lib libmwcoder_ToAsyncQueueTgtAppSvc.lib libmwsl_simtarget_instrumentation.lib libmwsl_simtarget_core.lib libmwstringutil.lib libmx.lib libmex.lib
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 0

#--------------------------- Model and reference models -----------------------
MODELLIB                  = HevMmPowertrainController_msf.mexw64
MODELREF_LINK_LIBS        = C:/Users/Administrator/MATLAB/Projects/examples/HEVMM5/HEVMM/Work/slprj/sim/HevMmPowertrainController/HevMmPowertrainControllerlib.lib
MODELREF_LINK_RSPFILE     = HevMmPowertrainController_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/HevMmPowertrainController \
...
HevMmPowertrainController_msf.obj : $(START_DIR)/slprj/sim/HevMmPowertrainController/HevMmPowertrainController_msf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/sim/HevMmPowertrainController/HevMmPowertrainController_msf.c
