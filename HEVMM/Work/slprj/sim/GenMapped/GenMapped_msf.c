...
#define S_FUNCTION_NAME GenMapped_msf
#endif
...
static void mdlProcessParameters ( SimStruct * S ) { p0m0rjpmhn * localX = (
p0m0rjpmhn * ) ssGetContStates ( S ) ; }
#endif
static void mdlInitializeConditions ( SimStruct * S ) { nrueedofvms * dw = (
nrueedofvms * ) ssGetDWork ( S , 0 ) ; real_T * o_o_B_3_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; p0m0rjpmhn * localX = ( p0m0rjpmhn * )
ssGetContStates ( S ) ; d0e1f5rocg ( o_o_B_3_1 , localX ) ; } static void
mdlReset ( SimStruct * S ) { nrueedofvms * dw = ( nrueedofvms * ) ssGetDWork
( S , 0 ) ; p0m0rjpmhn * localX = ( p0m0rjpmhn * ) ssGetContStates ( S ) ;
fqb3rkobxm ( localX ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S
, int_T tid ) { nrueedofvms * dw = ( nrueedofvms * ) ssGetDWork ( S , 0 ) ;
real_T const * i_eabclxkacc = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
real_T const * i_i_eqrjdgdlwz = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ;
real_T const * i_i_m5ur0rffbi = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ;
real_T * o_o_B_3_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T *
o_B_3_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; p0m0rjpmhn * localX
= ( p0m0rjpmhn * ) ssGetContStates ( S ) ; if ( tid == 0 ) { GenMapped ( & (
dw -> rtm ) , i_eabclxkacc , i_i_eqrjdgdlwz , i_i_m5ur0rffbi , o_o_B_3_1 ,
o_B_3_2 , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX ) ; egso2rwuq2TID1 ( )
...
mr_GenMapped_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S , 2 ) ;
...
false ) ; ssRegisterMsgForNotSupportingMultiExecInst ( S ,
 "<diag_root><diag id=\"Simulink:blocks:LoggingBlockDoesNotSupportMultiExecInstancesWithCustomMsg\" pr=\"d\"><arguments><arg type=\"encoded\">RwBlAG4ATQBhAHAAcABlAGQALwBNAGEAcABwAGUAZAAgAEcAZQBuAGUAcgBhAHQAbwByAC8ATQBhAHAAcABlAGQAIABNAG8AdABvAHIAIABDAG8AcgBlACAAUwBwAGUAZQBkACAAMgAvAE0AbwB0AG8AcgAgAFUAbgBpAHQAcwAvAFAAbwB3AGUAcgAgAEEAYwBjAG8AdQBuAHQAaQBuAGcAIABCAHUAcwAgAEMAcgBlAGEAdABvAHIAAAA=</arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments><hs><h>AAAABbBp+UDL</h></hs><causes><diag id=\"Simulink:logLoadBlocks:SigLogMultiExecInsNoBusSupportMsg\" pr=\"d\"><msg encoded=\"yes\">TwBuAGwAeQAgAG4AbwBuAC0AYgB1AHMAIABzAGkAZwBuAGEAbABzACAAYwBhAG4AIABiAGUAIABsAG8AZwBnAGUAZAAgAGkAbgBzAGkAZABlACAARgBvAHIAIABFAGEAYwBoACAAcwB1AGIAcwB5AHMAdABlAG0AcwAuAAAA</msg></diag></causes></diag></diag_root>"
...
SS_SIMMODE_SIZES_CALL_ONLY ) { int_T retVal = 1 ; mr_GenMapped_MdlInfoRegFcn
( S , "GenMapped" , & retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( nrueedofvms ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { nrueedofvms * dw = (
nrueedofvms * ) ssGetDWork ( S , 0 ) ; p0m0rjpmhn * localX = ( p0m0rjpmhn * )
ssGetContStates ( S ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ;
ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , &
sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } alzelrhozn ( S ,
...
_GenericFcn fcn = S -> mdlInfo -> genericFcn ; } ef13dejgdl ( & ( dw -> rtm )
, & ( dw -> rtdw ) ) ; }
#define MDL_START
static void mdlStart ( SimStruct * S ) { nrueedofvms * dw = ( nrueedofvms * )
ssGetDWork ( S , 0 ) ; i433fn5aij ( & ( dw -> rtm ) , & ( dw -> rtdw ) ) ; }
#define RTW_GENERATED_DISABLE
static void mdlDisable ( SimStruct * S ) { nrueedofvms * dw = ( nrueedofvms *
) ssGetDWork ( S , 0 ) ; haimgy2xan ( & ( dw -> rtm ) , & ( dw -> rtdw ) ) ;
return ; } static void mdlOutputs ( SimStruct * S , int_T tid ) { nrueedofvms
* dw = ( nrueedofvms * ) ssGetDWork ( S , 0 ) ; real_T const * i_eabclxkacc =
( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_i_eqrjdgdlwz =
( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_i_m5ur0rffbi =
( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T * o_o_B_3_1 = ( real_T *
) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_3_2 = ( real_T * )
ssGetOutputPortSignal ( S , 1 ) ; p0m0rjpmhn * localX = ( p0m0rjpmhn * )
ssGetContStates ( S ) ; if ( tid == PARAMETER_TUNING_TID ) { GenMappedTID1 (
& ( dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } if ( tid !=
CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0 ,
tid ) || ssIsMinorTimeStep ( S ) ) { GenMapped ( & ( dw -> rtm ) ,
i_eabclxkacc , i_i_eqrjdgdlwz , i_i_m5ur0rffbi , o_o_B_3_1 , o_B_3_2 , & ( dw
-> rtb ) , & ( dw -> rtdw ) , localX ) ; } } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { nrueedofvms * dw = (
nrueedofvms * ) ssGetDWork ( S , 0 ) ; return ; }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) { nrueedofvms * dw = (
nrueedofvms * ) ssGetDWork ( S , 0 ) ; real_T const * i_i_eqrjdgdlwz = (
real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_i_m5ur0rffbi = (
real_T * ) ssGetInputPortSignal ( S , 2 ) ; eozg3wy3zb * localZCSV = (
eozg3wy3zb * ) ssGetNonsampledZCs ( S ) ; axzm3wwmtg ( i_i_eqrjdgdlwz ,
i_i_m5ur0rffbi , & ( dw -> rtb ) , & ( dw -> rtdw ) , localZCSV ) ; }
#define MDL_DERIVATIVES
static void mdlDerivatives ( SimStruct * S ) { nrueedofvms * dw = (
nrueedofvms * ) ssGetDWork ( S , 0 ) ; fcng003jj4 * localXdot = ( fcng003jj4
* ) ssGetdX ( S ) ; ih0oo4r0yo ( & ( dw -> rtb ) , localXdot ) ; } static
void mdlTerminate ( SimStruct * S ) { nrueedofvms * dw = ( nrueedofvms * )
ssGetDWork ( S , 0 ) ; ciygun30a3 ( & ( dw -> rtm ) ) ; return ; }
#define MDL_CLEANUP_RUNTIME_RESOURCES
static void mdlCleanupRuntimeResources ( SimStruct * S ) { nrueedofvms * dw =
( nrueedofvms * ) ssGetDWork ( S , 0 ) ; b2elyitmnp ( & ( dw -> rtm ) , & (
dw -> rtdw ) ) ; }
...
mxCreateStructMatrix ( 1 , 1 , 6 , simStateFieldNames ) ; { const p0m0rjpmhn
* localX = ( const p0m0rjpmhn * ) ssGetContStates ( S ) ; const size_t
numBytes = sizeof ( p0m0rjpmhn ) ; mxArray * storedX = mxCreateNumericMatrix
...
mr_GenMapped_GetDWork ( ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber ( ss , 0
, 1 , mdlrefDW ) ; } { mxArray * data =
mr_GenMapped_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss , 0 ,
...
p0m0rjpmhn * localX = ( p0m0rjpmhn * ) ssGetContStates ( S ) ; const size_t
numBytes = sizeof ( p0m0rjpmhn ) ; const mxArray * storedX =
mxGetFieldByNumber ( ss , 0 , 0 ) ; const UINT8_T * rawData = ( const UINT8_T
* ) mxGetData ( storedX ) ; memcpy ( localX , & rawData [ 0 ] , numBytes ) ;
} mr_GenMapped_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0
