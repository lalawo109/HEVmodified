...
MODEL                = GenMapped
MODULES              = GenMapped_msf.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/GenMapped_msf.mexw64
MAKEFILE             = GenMapped.mk
...
MODELLIB                  = GenMapped_msf.mexw64
MODELREF_LINK_LIBS        = C:/Users/Administrator/MATLAB/Projects/examples/HEVMM5/HEVMM/Work/slprj/sim/GenMapped/GenMappedlib.lib
MODELREF_LINK_RSPFILE     = GenMapped_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/GenMapped \
...
GenMapped_msf.obj : $(START_DIR)/slprj/sim/GenMapped/GenMapped_msf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/sim/GenMapped/GenMapped_msf.c
