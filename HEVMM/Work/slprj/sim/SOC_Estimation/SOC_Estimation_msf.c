...
mdlInitializeConditions ( SimStruct * S ) { cketgpc2z3 ( ) ; } static void
mdlReset ( SimStruct * S ) { h41aqbjehq ( ) ; } static void
mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { BMS_State_Enum const
* i_hswahibyj4 = ( BMS_State_Enum * ) ssGetInputPortSignal ( S , 0 ) ;
real32_T const * i_mq3nlfboc1 = ( real32_T * ) ssGetInputPortSignal ( S , 1 )
; real32_T const * i_okw1fjhthx = ( real32_T * ) ssGetInputPortSignal ( S , 3
) ; real32_T const * i_pgdwmu1goh = ( real32_T * ) ssGetInputPortSignal ( S ,
4 ) ; real32_T * o_B_15_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ;
real32_T * o_B_15_2 = ( real32_T * ) ssGetOutputPortSignal ( S , 1 ) ;
real32_T * o_B_15_3 = ( real32_T * ) ssGetOutputPortSignal ( S , 2 ) ; if (
tid == 0 ) { SOC_Estimation ( i_hswahibyj4 , i_mq3nlfboc1 , i_okw1fjhthx ,
i_pgdwmu1goh , o_B_15_1 , o_B_15_2 , o_B_15_3 ) ; f4ikgzst5j ( ) ; } } static
...
slmrInitializeIOPortDataVectors ( S , 7 , 3 ) ; if ( ! ssSetNumInputPorts ( S
...
false ) ; ssRegisterMsgForNotSupportingMultiExecInst ( S ,
 "<diag_root><diag id=\"Simulink:blocks:SubsysSetAsFcnNotSupported\" pr=\"d\"><arguments><arg type=\"encoded\">UwBPAEMAXwBFAHMAdABpAG0AYQB0AGkAbwBuAC8ATQBlAGEAcwB1AHIAZQBtAGUAbgB0ACAARgB1AG4AYwB0AGkAbwBuAAAA</arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg><arg type=\"encoded\">UwBPAEMAXwBFAHMAdABpAG0AYQB0AGkAbwBuAC8ATQBlAGEAcwB1AHIAZQBtAGUAbgB0ACAARgB1AG4AYwB0AGkAbwBuAAAA</arg></arguments><hs><h>AAAAQAmwgEDL</h></hs></diag></diag_root>"
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { real32_T const *
i_pgdwmu1goh = ( real32_T * ) ssGetInputPortSignal ( S , 4 ) ; void *
sysRanPtr = ( NULL ) ; int sysTid = 0 ; ssGetContextSysRanBCPtr ( S , &
sysRanPtr ) ; ssGetContextSysTid ( S , & sysTid ) ; if ( sysTid ==
CONSTANT_TID ) { sysTid = 0 ; } ekir1iaqx0 ( S ,
...
lgpwz0u0yd . rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn !=
( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { real32_T const * i_pgdwmu1goh = (
real32_T * ) ssGetInputPortSignal ( S , 4 ) ; mdlProcessParameters ( S ) ;
acaeyrlq5y ( i_pgdwmu1goh ) ; } static void mdlOutputs ( SimStruct * S ,
int_T tid ) { BMS_State_Enum const * i_hswahibyj4 = ( BMS_State_Enum * )
ssGetInputPortSignal ( S , 0 ) ; real32_T const * i_mq3nlfboc1 = ( real32_T *
) ssGetInputPortSignal ( S , 1 ) ; real32_T const * i_okw1fjhthx = ( real32_T
* ) ssGetInputPortSignal ( S , 3 ) ; real32_T const * i_pgdwmu1goh = (
real32_T * ) ssGetInputPortSignal ( S , 4 ) ; real32_T * o_B_15_1 = (
real32_T * ) ssGetOutputPortSignal ( S , 0 ) ; real32_T * o_B_15_2 = (
real32_T * ) ssGetOutputPortSignal ( S , 1 ) ; real32_T * o_B_15_3 = (
real32_T * ) ssGetOutputPortSignal ( S , 2 ) ; if ( tid ==
PARAMETER_TUNING_TID ) { SOC_EstimationTID1 ( ) ; } if ( tid != CONSTANT_TID
&& tid != PARAMETER_TUNING_TID ) { SOC_Estimation ( i_hswahibyj4 ,
i_mq3nlfboc1 , i_okw1fjhthx , i_pgdwmu1goh , o_B_15_1 , o_B_15_2 , o_B_15_3 )
; } }
#define MDL_UPDATE
