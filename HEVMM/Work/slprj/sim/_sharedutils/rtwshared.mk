...
MODEL                = rtwshared
MODULES              = look1_binlcapw.c look2_binlcapw.c rtGetInf.c rtGetNaN.c rt_nonfinite.c automldiffopen_z2UoJAQJ.c interp2_2K7msVEG.c look1_binlcpw.c look1_binlxpw.c rt_zcfcn.c BINARYSEARCH_real_T.c LookUp_real_T_real_T.c look2_binlcpw.c look1_iflf_binlcpw.c look1_iflf_binlxpw.c look1_iflf_pbinlxpw.c look2_iflf_pbinlcpw.c trisolve_n7TRiGBu.c xaxpy_IQ2dDuYr.c xdotc_L9OWMrp6.c xgemv_r0VDt5Ig.c xgemv_wWs4ocix.c xnrm2_5NL5eOB3.c xnrm2_Anysr1Sx.c xnrm2_oi0rQuNS.c xrot_VJS4xnBw.c xscal_YC54Gy7j.c xscal_o5SXdvJf.c xswap_sOCliIB6.c sumColumnB_EGkLp5Zh.c
...
NUMST                = 
NCSTATES             = 0
BUILDARGS            = MATLAB_ROOT=%MATLAB_ROOT% ALT_MATLAB_ROOT=%ALT_MATLAB_ROOT% MATLAB_BIN=%MATLAB_BIN% ALT_MATLAB_BIN=%ALT_MATLAB_BIN%  OPTS="-DNRT -DIS_SIM_TARGET"
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 0
ALLOCATIONFCN        = 0
