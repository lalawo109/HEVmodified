...
MODEL                = MotMapped
MODULES              = MotMapped_msf.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/MotMapped_msf.mexw64
MAKEFILE             = MotMapped.mk
...
MODELLIB                  = MotMapped_msf.mexw64
MODELREF_LINK_LIBS        = C:/Users/Administrator/MATLAB/Projects/examples/HEVMM5/HEVMM/Work/slprj/sim/MotMapped/MotMappedlib.lib
MODELREF_LINK_RSPFILE     = MotMapped_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/MotMapped \
...
MotMapped_msf.obj : $(START_DIR)/slprj/sim/MotMapped/MotMapped_msf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/sim/MotMapped/MotMapped_msf.c
