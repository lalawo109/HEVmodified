...
MODULES              = SiMappedEngine_msf.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/SiMappedEngine_msf.mexw64
MAKEFILE             = SiMappedEngine.mk
...
MODELLIB                  = SiMappedEngine_msf.mexw64
MODELREF_LINK_LIBS        = C:/Users/Administrator/MATLAB/Projects/examples/HEVMM5/HEVMM/Work/slprj/sim/SiMappedEngine/SiMappedEnginelib.lib
MODELREF_LINK_RSPFILE     = SiMappedEngine_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/SiMappedEngine \
...
SiMappedEngine_msf.obj : $(START_DIR)/slprj/sim/SiMappedEngine/SiMappedEngine_msf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/sim/SiMappedEngine/SiMappedEngine_msf.c
